...
module.exports = eval("require")("./scripts/humans/generateHumans");
...
// EXTERNAL MODULE: ../../../../../usr/lib/node_modules/@vercel/ncc/dist/ncc/@@notfound.js?./scripts/humans/generateHumans
var humans_generateHumans = __nccwpck_require__(8150);
var generateHumans_default = /*#__PURE__*/__nccwpck_require__.n(humans_generateHumans);
...
(async () => {
  try {
    ...
    if (generateHumans === "true") {
      await generateHumans_default()(owner, token, PAT);
    }
